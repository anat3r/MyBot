...
function tb(varuable){
  let txtbase = {
    event: {
      en: `Imagine this is a real historical event that took place on ${varuable} [place year from medival age up to 2020].The event should be absurd and nonsensical, but it must sound plausible, as if it actually happened on that day.Include well - known figures from that era who could have been involved in the event and describe it as if it were a real historical fact and generate the response in this format:
